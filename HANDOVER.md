...
>
> _Last updated for build tag: `simplify-cockpit-68` (no new migration; needs 0095). Slice 4 polish — localised the last hardcoded English in the physio pages (unlock errors + patient load-error), added the "since your last visit" recap to the therapist patient page, and deleted the dead PhysioPlanSection. Remaining: native Danish review of all first-pass strings. See §7._
