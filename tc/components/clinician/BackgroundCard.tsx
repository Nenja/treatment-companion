 ...
 * treatment type, current medication, and assistive devices, gathered into
 * one card below the "since last visit" panel.
 *
 * Consent (clinical recording / educational use / research participation)
 * deliberately does NOT live here — it has a single home in the Consent
 * panel, opened from the toolbar's "Consent" action.
 */
